-- Cursor animation using extmarks
-- Source: https://github.com/FractalCodeRicardo/dev-config/blob/master/nvim/lua/my/cursor-animation.lua

local ns = vim.api.nvim_create_namespace('CursorAnimation')

vim.api.nvim_set_hl(0, 'CursorAnimationStart', { bg = '#42f56c' })
vim.api.nvim_set_hl(0, 'CursorAnimationFade', { bg = '#2a9c45' })
vim.api.nvim_set_hl(0, 'CursorAnimationEnd', { bg = '#000000' })
