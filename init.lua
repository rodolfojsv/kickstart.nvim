    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Show hover information (variable values, macro expansions, documentation, etc.)
          map('<leader>?', vim.lsp.buf.hover, 'Show Hover Info')
      ...
      vim.list_extend(ensure_installed, {
        ...
        'roslyn', -- C# language server (from Crashdummyy registry)
      })
